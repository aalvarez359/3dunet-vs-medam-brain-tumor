...
**IMPORTANT: All dataset images and labels must be placed in your google drive directory using the following directory path for training and inference to work.**
...
Google Drive Directory Guide for https://drive.google.com/drive/folders/1mAqbM9HJ6-J0_SWVOey-MJGGAeZSE3Md?usp=drive_link
